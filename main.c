...
int main(int argc, char *argv[])
{
    ...
    do
    {
        ...
        case 2:
         ...
         subtotal=calculoDescuento(subtotal); \* los */
...
void imprimirFactura(float numa,float numb,float numc,float numd,float nume,float prca,float prcb,float prcc,float prcd,float prce,float tota,float totb,float totc,float totd,float tote,char nombre[],char cedula[])
{
            printf("Nombre: %s\n", nombre);
            printf("Nro. cédula: %s\n", cedula);
            printf("Producto                Número              valor           total\n");
